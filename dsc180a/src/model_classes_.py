...
class CNN_Classification(nn.Module):
    def __init__(self, input_size, kernel_size, hidden_sizes, num_classes):
        super(CNN_Classification, self).__init__()
        self.conv = nn.Conv1d(input_size, hidden_sizes[0], kernel_size)
...
class CNN_Regression(nn.Module):
    def __init__(self, input_size, kernel_size, hidden_sizes, output_size=1):
